...
- 双线传输线 Two-Wire Lines
  ...
  ![](image-20231006194357433.png)

- 同轴传输线 Coaxial Line

  ![](image-20231006195256527.png)

- 微带传输线 Microstrip Lines

  ![](image-20231006195357603.png)
  
- 三明治结构 Sandwich structure

  ![](image-20231006202501281.png)
  
- 平行板结构 Geometric representation

  ![](image-20231006202544687.png)
...
![](image-20231006211239186.png)

其中每一小段：

![](image-20231006211305592.png)
