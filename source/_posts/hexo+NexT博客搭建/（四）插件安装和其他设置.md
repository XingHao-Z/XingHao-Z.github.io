...
![image-20230728164318018](（四）插件安装和其他设置/image-20230728164318018.png)
...
![image-20230728165607469](（四）插件安装和其他设置/image-20230728165607469.png)

选第三个。

添加后会提示我们：

![image-20230728165711515](（四）插件安装和其他设置/image-20230728165711515.png)

打开腾讯云的控制台，进入`DNS 解析 DNSPod`

![image-20230728170842612](（四）插件安装和其他设置/image-20230728170842612.png)

选择你的域名，进入，点击`添加记录`

![image-20230728171051026](（四）插件安装和其他设置/image-20230728171051026.png)

主机记录填写上面**Name**，记录类型选择**Type**，记录值填写**Value**

![image-20230728171558589](（四）插件安装和其他设置/image-20230728171558589.png)
...
![image-20230728172758161](（四）插件安装和其他设置/image-20230728172758161.png)
